...
public class InvitesEventStore implements EventStore {
    ...
    public List<BaseEvent> getEvents(String aggregateId) {
        ...
        if(eventStream == null || eventStream.isEmpty()){
            throw new AggregateNotFoundException("Incorrect invite ID provided");
        }
    ...
    public List<String> getAggregateIds() {
        var eventStream = eventStoreRepository.findAll("invitesEventStore");
        if(eventStream == null || eventStream.isEmpty()){
            throw new IllegalStateException("Could not retrieve event stream from the invites event store!");
        }
